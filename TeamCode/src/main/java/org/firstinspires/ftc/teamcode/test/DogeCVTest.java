...
public class DogeCVTest extends OpMode {
    ...
    public void init() {
        ...
        cryptoboxDetector = new CryptoboxDetector(CryptoboxDetector.CryptoboxDetectionMode.BLUE);
        cryptoboxDetector.init(hardwareMap.appContext, ActivityViewDisplay.getInstance());
    ...
    public void loop() {
        ...
        telemetry.addData("Red Detected:", cryptoboxDetector.isRed());
        telemetry.addData("Blue Detected:", cryptoboxDetector.isBlue());
